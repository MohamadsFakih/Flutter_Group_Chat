...
class MessageTile extends StatefulWidget {
  ...
  required this.mesaage,required this.sender, required this.sentByMe}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(widget.sender,textAlign: TextAlign.center,style: const TextStyle(fontSize: 13,fontWeight: FontWeight.bold,
            color: Colors.white,letterSpacing: -0.2),),
            const SizedBox(height: 8,),
            Text(widget.mesaage,style: const TextStyle(fontSize: 16),textAlign: TextAlign.center,)
